...
int main (int argc, char* argv[]){
	...
	char argumentoInvalido[]="Introduce bien los argumentos\n";
   ...
   if(strcmp(argv[0], "./infinito")){
    ...
    else if(strcmp(argv[0], "veloz")){
        return 1;
	


         }else if{(strcmp(argv[0], "normal"||argv[0]))

            return 1;
        }

    if(argc>2){
		if(write(1,argumentoInvalido,sizeof(argumentoInvalido))==-1) 
		return 1;
	}
    return 1;
	}
